...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder().title(serviceName).description(
                        "Description: https://github.com/pascalschumann/job-shop-scheduler-microservice/blob/master/README.md")
                        .license("License: Apache License 2.0")
                        .licenseUrl("https://www.apache.org/licenses/LICENSE-2.0")
                        .termsOfServiceUrl("").version("1.0.0")
                        .contact(new Contact("Bug report",
                                        "https://github.com/pascalschumann/job-shop-scheduler-microservice/issues/new",
                                        ""))
                        .build();
    }
}
