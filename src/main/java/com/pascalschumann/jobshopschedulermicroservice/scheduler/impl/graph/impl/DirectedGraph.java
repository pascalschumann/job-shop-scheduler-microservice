...
/**
 * An impl for a directed graph. It's important to always return null if aggregation is empty (simplify error detecting,
 * since no empty collections should pass through the program). A directed graph is stored/read in by its edges, from
 * that edges a list of nodes is built up where every node has:<br>
...
implements IDirectedGraph {
	...
	@Override
	public void RemoveNode(final INode node, final boolean connectParentsWithChilds, final boolean removeEdges) // TODO
																												// =
																												// true)
	{
	...
	@Override
	public void RemoveNode(final Id nodeId, final boolean connectParentsWithChilds, final boolean removeEdges) // TODO =
																												// true)
	{
