...
public class Machine {
	...
	// wrapped value
	private final com.pascalschumann.jobshopscheduler.api.model.Machine machineFromApi;
	// more members
	private Long idleStart = 0L;

	public Machine(final com.pascalschumann.jobshopscheduler.api.model.Machine machineFromApi) {
