package com.pascalschumann.jobshopschedulermicroservice.integration;
...
import com.pascalschumann.jobshopschedulermicroservice.Application;
...
public class AbstractIT {
    ...
    public void before() {
        REQUEST_SPECIFICATION = new RequestSpecBuilder().setBaseUri(BASE_URL)
                        .setAuth(RestAssured.basic(userAdmin.getName(), userAdmin.getPassword()))
